// ============================================================
// znty-rrs 全局字典常量（参考文档）
// ============================================================
// 维护说明：本文件为 code→中文名称 的统一参考字典，与后端枚举
//          （com.znty.rrs.common.enums）及 dict_security_type 演示数据逐项核对。
...
const DICT_ADJUST_TYPE = {
    ...
    'Excel导入':    'Excel导入',    // Excel 导入手工主项（校验展示与落库一致；对齐批量「手动批量调整」的渠道专属口径）
    'Excel清空':    'Excel清空',    // Excel 导入勾选「首先清空目标池」产生的差集出库
...
// 枚举：EventType
// 表：各 _evt 审计表（统一存英文 code）
// 说明：INSERT/UPDATE/DELETE，中文仅作前端展示
